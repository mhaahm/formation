    ...
    <app-layout>
        <template #header>
            <h2 class="font-semibold text-xl text-gray-800 leading-tight">
                Modification du {{ courseData.title }}
            </h2>
        </template>
                ...
                <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                    ...
                    <div class="bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4 flex flex-col">
                        <div class="mb-4">
                            ...
                            <input class="shadow appearance-none border rounded w-full py-2 px-3 text-grey-darker" id="title" type="text" v-model="courseData.title">
                        ...
                        <div class="mb-6">
                            ...
                            <textarea class="shadow appearance-none border rounded w-full py-2 px-3 text-grey-darker" id="description" type="text" v-model="courseData.description"></textarea>
                        ...
                        <div class="md-4">
                            <div class="justify-between flex">
                                ...
                                <button class="bg-green-300 hover:bg-blue-dark text-white font-bold py-2 px-4 rounded" @click.prevent="addEpisode()" v-if="courseData.episodes.length < 15">
                                    Add Episode
                                </button>
                            </div>
                            ...
                            <div v-for="(episode,index) in courseData.episodes" v-bind:key="index">
                                ...
                                <input class="shadow appearance-none border rounded w-full py-2 px-3 text-grey-darker" :id="'title'+index" type="text" v-model="courseData.episodes[index].title">
                                ...
                                <input class="shadow appearance-none border rounded w-full py-2 px-3 text-grey-darker" :id="'video_url'+index" type="text" v-model="courseData.episodes[index].video_url">
                                <div class="bg-red-100 text-red-800 p-4 mt-2"
                                ...
                                <textarea class="shadow appearance-none border rounded w-full py-2 px-3 text-grey-darker" :id="'description'+index" type="text" v-model="courseData.episodes[index].description"></textarea>
                                <div class="bg-red-100 text-red-800 p-4 mt-2"
                                     v-if="$page.errors['episodes.'+index+'.description']">
                                    {{ $page.errors['episodes.'+index+'.description'][0] }}
                                </div>

                                <div class="mt-3 mb-3 flex justify-end" v-if="courseData.episodes.length>1">
...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            deleteEpisode(index) {
                delete this.courseData.episodes.splice(index)
            }
        }
    }
</script>
